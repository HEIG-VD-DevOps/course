...
const config: Config = {
  ...
  url: "https://heig-vd-devops.github.io/",
  baseUrl: "/course/",
  organizationName: 'HEIG-VD-DevOps',
  projectName: 'course',
  trailingSlash: false,
