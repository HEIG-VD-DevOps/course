...
- Obtenir son adresse IP.
  ...
  - Windows: `ipconfig`
- Enregistrer son équipe sur le serveur de jeu (adresse donné en cours).
- Planifier le travail de l'équipe.
  - Découper le travail en tâches et noter les différentes étapes.
    - Optionnel : voir [The Art of Slicing](https://emorabia.medium.com/the-art-of-slicing-1c6ceb93d5c0).
