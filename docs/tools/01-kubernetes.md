...
- Rancher (login) : `rke2.iict-heig-vd.in/dashboard/auth/login?timed-out`
  - Se connecter avec le compte HES-SO (AD).
  - Ouvrir le cluster `iict-students` : `rke2.iict-heig-vd.in/dashboard/c/c-m-jksmqh24/explorer#cluster-events`
